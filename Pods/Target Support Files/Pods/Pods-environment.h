...
#define COCOAPODS_VERSION_MAJOR_IMFPush 0
#define COCOAPODS_VERSION_MINOR_IMFPush 1
#define COCOAPODS_VERSION_PATCH_IMFPush 2

// IMFURLProtocol
#define COCOAPODS_POD_AVAILABLE_IMFURLProtocol
#define COCOAPODS_VERSION_MAJOR_IMFURLProtocol 0
#define COCOAPODS_VERSION_MINOR_IMFURLProtocol 1
